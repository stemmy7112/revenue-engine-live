...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-glow/5 rounded-full blur-[120px]" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {isLogin ? "Sign in to access your dashboard" : "Start discovering income opportunities"}
          </p>
        </div>
        ...
        <div className="p-8 rounded-xl bg-card border border-border">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 rounded-lg border border-border bg-muted hover:bg-secondary text-foreground font-medium transition-all text-sm"
          >
